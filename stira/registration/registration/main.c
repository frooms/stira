 ...
 */
		//reg.directives.maskCombine = BRAND_OR;
		//reg.directives.maskCombine = BRAND_NOR;
		reg.directives.maskCombine = BRAND_AND; /* Strongly recommended choice */
		//reg.directives.maskCombine = BRAND_NAND;
		//reg.directives.maskCombine = BRAND_XOR;
		//reg.directives.maskCombine = BRAND_NXOR;
...
/* Actual call to the procedure */
                struct fitRec params;
		regFloat3d(&reg, &params);
