...
T Pyramid<T>::GetAverageConeRatioSubSampled( int x, int y, int orientationNr, int finestScale, int coarsestScale )
{
   ...
   T coarserAbsMean = NumberGridTools<double>::ComputeLocalAbsoluteMean(  this->GetRecursiveScale( coarsestScale-1 )->GetOrientedBand( orientationNr ), xTopLeft, yTopLeft, xBottomRight, yBottomRight );
   T finerAbsMean;
   ...
   for (int scaleNr = coarsestScale-2; scaleNr >= finestScale; scaleNr--)
   {
      ...
      finerAbsMean = NumberGridTools<double>::ComputeLocalAbsoluteMean(  this->GetRecursiveScale( scaleNr )->GetOrientedBand( orientationNr ), xTopLeft, yTopLeft, xBottomRight, yBottomRight );
...
T Pyramid<T>::GetAverageConeRatioRedundant( int x, int y, int orientationNr, int finestScale, int coarsestScale )
{
   ...
   T   coarserAbsMean    = NumberGridTools<double>::ComputeLocalAbsoluteMean(  this->GetRecursiveScale( coarsestScale-1 )->GetOrientedBand( orientationNr ), x - coarserWindowHalfSize, y - coarserWindowHalfSize,
   ...
   for (int scaleNr = coarsestScale-2; scaleNr >= finestScale; scaleNr--)
   {
      ...
      finerAbsMean = NumberGridTools<double>::ComputeLocalAbsoluteMean(  this->GetRecursiveScale( scaleNr )->GetOrientedBand( orientationNr ), x - finerWindowHalfSize, y - finerWindowHalfSize,
