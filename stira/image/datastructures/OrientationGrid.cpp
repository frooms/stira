...
void OrientationGrid::ExportMagnitudeImage( std::string fileNameMagnitude )
{
   Image *pMagnitudeImage = VisualizeMagnitudeImage( );
   ImageIO::Write( pMagnitudeImage, fileNameMagnitude, ImageIO::NORMAL_OUT);
   delete pMagnitudeImage;
}

//============================================================================

void OrientationGrid::ExportOrientationImage( std::string fileNameDirection, double threshold, ColorExportMode myMode)
{
   Image *pOrientationImage = VisualizeOrientationImage( threshold, myMode );
   ImageIO::Write( pOrientationImage, fileNameDirection, ImageIO::NORMAL_OUT);
   delete pOrientationImage;
}
